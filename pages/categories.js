    ...
    return(
        <div className="container" style={{marginTop: '30px' }}>
            ...
            <div className="input-group mb-3">
                ...
                <button className="btn btn-secondary ml-1 shadow-none "
            ...
            
            {
                categories.map(category => (
                    <div key={category._id} className="card my-2 text-capitaliza">
                        <div className="card-body d-flex justify-content-between">
                            {category.name}

                            <div style={{cursor: 'pointer'}}>
                                <i className="fal fa-edit text-info" style={{marginRight: '10px'}}
